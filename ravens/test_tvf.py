...
def main(unused_argv):
  ...
  for train_run in range(FLAGS.n_runs):
    ...
    attention_model_path = f'./gctn_models/attention-ckpt-{test_total_steps}.h5'
    transport_model_path = f'./gctn_models/transport-ckpt-{test_total_steps}.h5'
